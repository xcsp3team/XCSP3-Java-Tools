...
public abstract class ProblemIMP {
	...
	public abstract CtrEntity minimum(XNode<IVar>[] trees, Condition condition);
	...
	public abstract ObjEntity minimize(XNode<IVar> tree);

	public abstract ObjEntity maximize(XNode<IVar> tree);

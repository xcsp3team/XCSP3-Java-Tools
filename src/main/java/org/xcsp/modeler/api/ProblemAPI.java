...
public interface ProblemAPI extends ProblemAPIOnVars, ProblemAPIOnVals, ProblemAPISymbolic {
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/intension">{@code intension}</a> from the specified
	...
	/**
	 * Returns the root of a syntactic tree built with the unary operator <code>abs</code> applied to the specified
	 * operand. For example, one possible call is <code>abs(sub(x,y))</code> that represents <code>|x-y|</code>
	 * 
	 * @param operand
	...
	/**
	 * Returns the root of a syntactic tree built with the unary operator <code>neg</code> applied to the specified
	 * operand. For example, one possible call is <code>neg(add(x,y))</code> that represents <code>-(x+y)</code>
	 * 
	 * @param operand
	 *            an object that can be an integer, a variable, or an object {@code XNode}
	 * @return an object {@code XNodeParent} that represents the root of a syntactic tree
	...
	/**
	 * Returns the root of a syntactic tree built with the unary operator <code>sqr</code> applied to the specified
	 * operand. For example, one possible call is <code>sqr(x)</code> that represents <code>x*x</code>
	 * 
	 * @param operand
	 *            an object that can be an integer, a variable, or an object {@code XNode}
	 * @return an object {@code XNodeParent} that represents the root of a syntactic tree
	...
	/**
	 * Returns the root of a syntactic tree built with the operator <code>add</code> applied to the specified operands.
	 * For example, one possible call is <code>add(x,y,z)</code> that represents <code>x+y+z</code>
	 * 
	 * @param operands
	...
	/**
	 * Returns the root of a syntactic tree built with the binary operator <code>sub</code> applied to the specified
	 * operands. For example, one possible call is <code>sub(x,y)</code> that represents <code>x-y</code>
	 * 
	 * @param operand1
	...
	/**
	 * Returns the root of a syntactic tree built with the operator <code>mul</code> applied to the specified operands.
	 * For example, one possible call is <code>mul(x,y)</code> that represents <code>x*y</code>
	 * 
	 * @param operands
	 *            a sequence of operands that can be integers, variables, or objects {@code XNode}
	 * @return an object {@code XNodeParent} that represents the root of a syntactic tree
	...
	/**
	 * Returns the root of a syntactic tree built with the binary operator <code>div</code> applied to the specified
	 * operands. For example, one possible call is <code>div(x,y)</code> that represents <code>x/y</code> (integer
	 * division)
	 * 
	 * @param operand1
	 *            the first operand that can be an integer, a variable, or an object {@code XNode}
	...
	/**
	 * Returns the root of a syntactic tree built with the binary operator <code>mod</code> applied to the specified
	 * operands. For example, one possible call is <code>mod(x,2)</code> that represents <code>x%2</code>
	 * 
	 * @param operand1
	 *            the first operand that can be an integer, a variable, or an object {@code XNode}
	 * @param operand2
	...
	/**
	 * Returns the root of a syntactic tree built with the binary operator <code>pow</code> applied to the specified
	 * operands. For example, one possible call is <code>pow(x,3)</code> that represents <code>x^3</code>
	 * 
	 * @param operand1
	 *            the first operand that can be an integer, a variable, or an object {@code XNode}
	 * @param operand2
	...
	/**
	 * Returns the root of a syntactic tree built with the operator <code>min</code> applied to the specified operands.
	 * For example, one possible call is <code>min(x,y,z)</code>
	 * 
	 * @param operands
	 *            a sequence of operands that can be integers, variables, or objects {@code XNode}
	 * @return an object {@code XNodeParent} that represents the root of a syntactic tree
	...
	/**
	 * Returns the root of a syntactic tree built with the operator <code>max</code> applied to the specified operands.
	 * For example, one possible call is <code>max(x,y,z)</code>.
	 * 
	 * @param operands
	 *            a sequence of operands that can be integers, variables, or objects {@code XNode}
	 * @return an object {@code XNodeParent} that represents the root of a syntactic tree
	...
	/**
	 * Returns the root of a syntactic tree built with the binary operator <code>dist</code> applied to the specified
	 * operands. For example, one possible call is <code>dist(x,y)</code> that represents <code>|x-y|</code>
	 * 
	 * @param operand1
	 *            the first operand that can be an integer, a variable, or an object {@code XNode}
	 * @param operand2
	...
	/**
	 * Returns the root of a syntactic tree built with the binary operator <code>lt</code> applied to the specified
	 * operands. For example, one possible call is <code>lt(x,10 </code> that represents <code>x<10</code>
	 * 
	 * @param operand1
	 *            the first operand that can be an integer, a variable, or an object {@code XNode}
	 * @param operand2
	...
	/**
	 * Returns the root of a syntactic tree built with the binary operator <code>le</code> applied to the specified
	 * operands. For example, one possible call is <code>le(x,10)</code> that represents <code>x&le;10</code>
	 * 
	 * @param operand1
	 *            the first operand that can be an integer, a variable, or an object {@code XNode}
	 * @param operand2
	...
	/**
	 * Returns the root of a syntactic tree built with the binary operator <code>ge</code> applied to the specified
	 * operands. For example, one possible call is <code>ge(x,10)</code> that represents <code>x&ge;10</code>
	 * 
	 * @param operand1
	 *            the first operand that can be an integer, a variable, or an object {@code XNode}
	 * @param operand2
	...
	/**
	 * Returns the root of a syntactic tree built with the binary operator <code>gt</code> applied to the specified
	 * operands. For example, one possible call is <code>gt(x,10)</code> that represents <code>x>10</code>
	 * 
	 * @param operand1
	 *            the first operand that can be an integer, a variable, or an object {@code XNode}
	 * @param operand2
	...
	/**
	 * Returns the root of a syntactic tree built with the operator <code>ne</code> applied to the specified operands.
	 * For example, one possible call is <code>ne(x,y)</code> that represents <code>x&ne;y</code>
	 * 
	 * @param operands
	 *            a sequence of operands that can be integers, variables, or objects {@code XNode}
	 * @return an object {@code XNodeParent} that represents the root of a syntactic tree
	...
	/**
	 * Returns the root of a syntactic tree built with the operator <code>eq</code> applied to the specified operands.
	 * For example, one possible call is <code>eq(x,y)</code> that represents <code>x=y</code>
	 * 
	 * @param operands
	 *            a sequence of operands that can be integers, variables, or objects {@code XNode}
	 * @return an object {@code XNodeParent} that represents the root of a syntactic tree
	...
	/**
	 * Returns the root of a syntactic tree built with the operator <code>set</code> applied to the specified operands.
	 * For example, one possible call is <code>set(1,2,3)</code> that represents <code>{1,2,3}</code>
	 * 
	 * @param operands
	 *            a sequence of operands that can be integers, variables, or objects {@code XNode}
	...
	/**
	 * Returns the node of a syntactic tree built with the operator <code>set</code> applied to the integers from the
	 * specified array. For example, if {@code t} id an array containing values 1, 2 and 3, then the call
	 * <code>set(t)</code> represents <code>{1,2,3}</code>
	 * 
	 * @param operands
	...
	/**
	 * Returns the root of a syntactic tree built with the operator <code>in</code> applied to the specified operands.
	 * For example, one possible call is <code>in(x,set(1,2,3))</code> that represents <code>x&in;{1,2,3}</code>
	 * 
	 * @param var
	...
	/**
	 * Returns the root of a syntactic tree built with the operator <code>notin</code> applied to the specified
	 * operands. For example, one possible call is <code>notin(x,set(1,2,3))</code> that represents
	 * <code>x&notin;{1,2,3}</code>
	 * 
	 * @param var
	 *            the first operand that is typically a variable but can also can be an object {@code XNode}
	 * @param set
	...
	/**
	 * Returns the root of a syntactic tree built with the unary operator <code>not</code> applied to the specified
	 * operand. For example, one possible call is <code>not(eq(x,y))</code> that represents <code>&not;(x=y)</code>
	 * 
	 * @param operand
	 *            an object that can be an integer, a variable, or an object {@code XNode}
	 * @return an object {@code XNodeParent} that represents the root of a syntactic tree
	...
	/**
	 * Returns the root of a syntactic tree built with the operator <code>and</code> applied to the specified operands.
	 * For example, one possible call is <code>and(eq(x,y),lt(z,3))</code> that represents <code>x=y&and;z<3</code>
	 * 
	 * @param operands
	 *            a sequence of operands that can be integers, variables, or objects {@code XNode}
	 * @return an object {@code XNode} that represents the node of a syntactic tree
	...
	/**
	 * Returns the root of a syntactic tree built with the operator <code>or</code> applied to the specified operands.
	 * For example, one possible call is <code>or(eq(x,y),lt(z,3))</code> that represents <code>x=y&or;z<3</code>
	 * 
	 * @param operands
	 *            a sequence of operands that can be integers, variables, or objects {@code XNode}
	 * @return an object {@code XNode} that represents the node of a syntactic tree
	...
	/**
	 * Returns the root of a syntactic tree built with the operator <code>xor</code> applied to the specified operands.
	 * For example, one possible call is <code>xor(eq(x,y),lt(z,3))</code> that represents <code>x=y&xoplus;z<3</code>
	 * 
	 * @param operands
	 *            a sequence of operands that can be integers, variables, or objects {@code XNode}
	 * @return an object {@code XNode} that represents the node of a syntactic tree
	...
	/**
	 * Returns the root of a syntactic tree built with the operator <code>iff</code> applied to the specified operands.
	 * For example, one possible call is <code>iff(eq(x,y),lt(z,3))</code> that represents <code>x=y&hArr;z<3</code>
	 * 
	 * @param operands
	 *            a sequence of operands that can be integers, variables, or objects {@code XNode}
	 * @return an object {@code XNode} that represents the node of a syntactic tree
	...
	/**
	 * Returns the root of a syntactic tree built with the binary operator <code>imp</code> applied to the specified
	 * operands. For example, one possible call is <code>imp(eq(x,y),lt(z,3)</code> that represents
	 * <code>x=y&rArr;z<3</code>
	 * 
	 * @param operand1
	 *            the first operand that can be an integer, a variable, or an object {@code XNode}
	 * @param operand2
	...
	/**
	 * Returns the root of a syntactic tree built with the binary operator <code>if</code> applied to the specified
	 * operands. For example, one possible call is <code>if(eq(x,y),2,4)</code> that represents <code>x=y?2:4</code>
	 * 
	 * @param operand1
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/intension">{@code intension}</a>, while considering
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/extension">{@code extension}</a> from the specified
	...
	/**
	 * Builds a unary constraint <a href="http://xcsp.org/specifications/extension">{@code extension}</a> from the
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/regular">{@code regular}</a> from the specified scope
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/mdd">{@code mdd}</a> from the specified scope and the
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/allDifferent">{@code allDifferent}</a> on the
	...
	@Deprecated
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/allDifferent">{@code allDifferentExcept}</a> on the
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/allDifferent">{@code allDifferentList}</a> on the
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/allDifferent">{@code allDifferentMatrix}</a> on the
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/allEqual">{@code allEqual}</a> on the specified
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/allEqual">{@code allEqualList}</a> on the specified
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/ordered">{@code ordered}</a> on the specified lists
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/ordered">{@code lex}</a> on the specified
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/ordered">{@code lexMatrix}</a> on the specified
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/sum">{@code sum}</a> from the specified arguments:
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/count">{@code count}</a> from the specified
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/nValues">{@code nValues}</a> from the specified
	...
	/**
	 * Builds a constraint <a href= "http://xcsp.org/specifications/cardinality">{@code cardinality}</a> from the
	 ...
	 * <li>when the object {@code Occurrences} represents a 1-dimensional array of integers {@code t}, obtained by
	 * calling Method {@code occurExactly(int[])}, {@code k_i} must be exactly {@code t[i]}</li>
	 * <li>when the object {@code OccursEachBetweeen} represents an interval of integers {@code v..w}, obtained by
	 * calling Method {@code occursEachBetween(int,int)}, {@code k_i} must belong to {@code v..w}</li>
	 * <li>when the object {@code OccursBetween} represents two 1-dimensional arrays of integers {@code t1 and t2},
	 * obtained by calling Method {@code occurBetween(int[],int[])}, {@code k_i} must belong to
	 * {@code t1[i]..t2[i]}</li>
	 * <li>when the object {@code Occurrences} represents a 1-dimensional array of integer variables {@code x}, obtained
	 * by calling Method {@code occurExactly(Var[])}, {@code k_i} must be the same value as {@code x[i]}</li>
	 * </ul>
	 * Note that when the specified boolean is {@code true}, it is required that all variables in {@code list} are
	 * assigned a value in {@code values}. <br>
	 * 
	...
	/**
	 * Builds a constraint <a href= "http://xcsp.org/specifications/maximum">{@code maximum}</a> from the specified
	 * arguments: the maximum of the values assigned to the variables of {@code list} must respect the specified
	 * condition. Note that the array {@code list} is cleaned (i.e., {@code null} values are discarded). <br>
	 ...
	 * <ul>
	 * <li>the smallest valid number (FIRST), meaning that {@code index.variable} must refer to the first variable in
	 * {@code list} with maximum value</li>
	 * <li>the greatest valid number (LAST), meaning that {@code index.variable} must refer to the last variable in
	 * {@code list} with maximum value</li>
	 * <li>or any valid number (ANY), meaning that {@code index.variable} can refer to any variable in {@code list} with
	 * maximum value.</li>
	 * </ul>
	 * <b>Important:</b> for building an object {@code Index}, use Method {@code index(Var)} or Method
	 * {@code index(Var,TypeRank)}. <br>
	 * 
	 ...
	 * maximum value.</li>
	 * </ul>
	 * <b>Important:</b> for building an object {@code StartIndex}, use Method {@code startIndex(int)}, for building an
	 ...
	 * </ul>
	 * <b>Important:</b> for building an object {@code Index}, use Method {@code index(Var)} or Method
	 * {@code index(Var,TypeRank)} and for building an object {@code Condition} use methods {@code condition()}. <br>
	 * 
	...
	/**
	 * Builds a constraint <a href= "http://xcsp.org/specifications/minimum">{@code minimum}</a> from the specified
	 ...
	 * <ul>
	 * <li>the smallest valid number (FIRST), meaning that {@code index.variable} must refer to the first variable in
	 * {@code list} with minimum value</li>
	 * <li>the greatest valid number (LAST), meaning that {@code index.variable} must refer to the last variable in
	 * {@code list} with minimum value</li>
	 * <li>or any valid number (ANY), meaning that {@code index.variable} can refer to any variable in {@code list} with
	 * minimum value.</li>
	...
	/**
	 * Builds a constraint <a href= "http://xcsp.org/specifications/channel">{@code channel}</a> from the specified
	 ...
	 * access the first variable in {@code list}. <b>Important:</b> for building an object {@code StartIndex}, use
	 ...
	 * Builds a constraint <a href= "http://xcsp.org/specifications/channel">{@code channel}</a> from the specified
	 * arguments: the value {@code j} is assigned to the ith variable of {@code list} iff the value {@code i} is
	 * assigned to the jth variable of {@code list}. Note that indexing starts at 0 (default value). <br>
	 * 
	 ...
	 * <b>Important:</b> for building an object {@code StartIndex}, use Method {@code startIndex(int)} <br>
	 * 
	 ...
	 * variable in {@code list}. <b>Important:</b> for building an object {@code StartIndex}, use Method
	 ...
	 * arguments: the value {@code i} is assigned to {@code value} iff only the ith variable of {@code list} is assigned
	 * the value 1 (0 is the value assigned to the other variables of {@code list}). Note that {@code list} must only
	 * contain variables with domain 0/1 and that indexing starts at 0 (default value). <br>
	 * 
	...
	/**
	 * Builds a constraint <a href= "http://xcsp.org/specifications/noOverlap">{@code noOverlap}</a> from the specified
	 ...
	 * Builds a constraint <a href= "http://xcsp.org/specifications/noOverlap">{@code noOverlap}</a> from the specified
	 * arguments: we are given a set of tasks, defined by their origins and durations (lengths), which must not overlap.
	 * Note that zero-length tasks are simply ignored (default value). <br>
	 * 
	 * As an illustration, enforcing that tasks defined by x (origins) and t (lengths) must not overlap is given by:
	 * 
	 * <pre>
	...
	/**
	 * Builds a constraint <a href= "http://xcsp.org/specifications/noOverlap">{@code noOverlap}</a> from the specified
	 * arguments: we are given two tasks, defined by their origins and durations (lengths), which must not overlap. <br>
	 * 
	 ...
	 * that zero-length tasks are simply ignored (default value). <br>
	 * 
	 ...
	 * arguments: we are given a set of tasks, defined by their origins and durations (lengths), which must not overlap.
	 * The ith task is defined by its origin {@code origins[i][j]} wrt the jth axis and its length {@code lengths[i][j]}
	 * wrt the jth axis. Note that tasks of length 0 on some axis are simply ignored (default value). <br>
	 * 
	 * As an illustration, enforcing that tasks defined by x (origins) and y (lengths) must not overlap is given by:
	 * 
	 * <pre>
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/circuit">{@code circuit}</a> from the specified
	 * arguments.
	 * 
	 * @param list
	 *            an array of variables
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/circuit">{@code circuit}</a> on the specified array
	...
	/**
	 * Builds a constraint <a href="http://xcsp.org/specifications/instantiation">{@code instantiation}</a>, assigning
	...
	/**
	 * Builds a meta-constraint <a href="http://xcsp.org/specifications/slide">{@code slide}</a> from the specified
	...
	/**
	 * Builds an <a href="http://xcsp.org/specifications/objectives">objective</a> (function) to minimize: the value of
	...
	/**
	 * Builds an <a href="http://xcsp.org/specifications/objectives">objective</a> (function) to maximize: the value of
	 * the specified variable.
	 * 
	 * @param x
	 *            a variable
	...
	/**
	 * Builds an <a href="http://xcsp.org/specifications/objectives">objective</a> (function) to minimize: the objective
	...
	/**
	 * Builds an <a href="http://xcsp.org/specifications/objectives">objective</a> (function) to maximize: the objective
	 * is defined by the specified type on the specified array of variables. For example:
	 * 
	 * <pre>
	 * {@code

...
public XCSP3(String fileName) throws Exception {
  ...
  implem().currentParameters.put(XCallbacksParameters.INTENSION_TO_EXTENSION_ARITY_LIMIT, 3); 
  implem().currentParameters.put(XCallbacksParameters.INTENSION_TO_EXTENSION_SPACE_LIMIT, 1000000);
  implem().currentParameters.put(XCallbacksParameters.INTENSION_TO_EXTENSION_PRIORITY, Boolean.TRUE);
  loadInstance(fileName); 
}
\end{absc} 
\end{boxabsc}
